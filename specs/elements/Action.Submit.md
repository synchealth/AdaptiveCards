...
| -------- | ---- | -------- | ----------- | ------- |
| **type** | `"Action.Submit"` |  No | Must be `Action.Submit` | 1.0 |
| **data** | `string` |  No | Initial data that input fields will be combined with. These are essentially ‘hidden’ properties. | 1.0 |
