...
| -------- | ---- | -------- | ----------- | ------- |
| **type** | `"AdaptiveCard"` |  No | Must be `AdaptiveCard` | 1.0 |
...
| **selectAction** | `any` |  No | An Action that will be invoked when the card is tapped or selected. `Action.ShowCard` is not supported. | 1.1 |
...
| **backgroundImage** | `object` |  No | Specifies the background image of the card. | 1.2 |
...
| **$schema** | `string` |  No | The Adaptive Card schema. | 1.0 |
<!-- END AUTO-GENERATED -->
